        ...
        <>
          <div className="grid grid-cols-2 gap-3">
            <Field label="Type" htmlFor="type">
              <NativeSelect id="type" name="type" defaultValue="purchase_order">
                <option value="purchase_order">Purchase order</option>
                <option value="subcontract">Subcontract</option>
              </NativeSelect>
            </Field>
            <Field label="Vendor" htmlFor="vendorId" required error={errors.vendorId}>
              <NativeSelect id="vendorId" name="vendorId" defaultValue="" required>
          ...
          <Field label="Title" htmlFor="title" required error={errors.title}>
            <Input id="title" name="title" required placeholder="Rebar supply — Tower A" />
          </Field>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Expected date" htmlFor="expectedDate">
              <DateField name="expectedDate" />
            </Field>
          </div>

          <Field label="Payment terms" htmlFor="paymentTerms">
            <Input id="paymentTerms" name="paymentTerms" placeholder="30 days net" />
          </Field>
